...
def main(k=6):
    ...
    X_train = scaler.fit_transform(train_df[RAW_FEATURES])
    X_val = scaler.transform(val_df[RAW_FEATURES])
    X_test = scaler.transform(test_df[RAW_FEATURES])
    ...
    output_csv = RESULTS_DIR / "pseudolabels_k6_raw.csv"
